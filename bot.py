...
async def send_receipt_instructions(message: Message):
    ...
    if drv:
        text = (
            ...
            "🏦 Банк: <b>Ipak yo`li</b>\n"
            "💳 Карта рақами: <code>9860 1701 1312 1090</code>\n"
            "👤 Эгаси: <b>Saidjaxanov Raximjon</b>\n\n"
            f"📌 Тўлов қилаётганда изоҳга ўз <b>Telegram ID</b> рақамингизни ёзинг: Сизнинг Telegram ID рақамингиз 👉🏻<code>{message.from_user.id}</code>\n\n"
